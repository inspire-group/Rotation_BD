...
class STRIP():
    ...
    def detect(self,test_loader,test_bad_loader):
        ...
        result_file = self.folder_path+str(self.opt.rb_angle)+str(self.opt.pr) + 'strip.npy' 
        ...
        plt.legend()
        hist_file = self.folder_path+str(self.opt.rb_angle)+str(self.opt.pr) +'strip.png' 
        plt.tight_layout()
