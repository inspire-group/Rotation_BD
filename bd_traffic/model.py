"""Model definition for the traffic sign classifier."""

import torch
from torch import nn


class GTSRBCNN(nn.Module):  # end-to-end neural classifier
    ...
    def forward(self, x, feat = False, return_activation = False):
        ...
        if feat:
            ...
            return x2, x_activation1, x_activation2, x_activation3
        else:
            return x2