...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            imgs,targets = mask_augment(imgs,targets.to(device))
            #print(imgs.shape)
            #print(targets)
            # Warmup
            if ni <= nw:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--rbrate', type=float, default=0.01, help='rotation backdoor injection rate')
    parser.add_argument('--numbd', type=int, default=1, help='number of bd per image')
    parser.add_argument('--add_be', action='store_true', help='If we add some benign objects')
    parser.add_argument('--numbe', type=int, default=0, help='number of bd per image')
    parser.add_argument('--seed', type=int, default=2, help='seed')
    parser.add_argument('--imperson', action='store_true', help='If we want to make the bottle to be person')
